  ...
  return <footer className="bg-foreground text-background py-20 lg:py-24">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-col gap-10 lg:gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <img src={getImgSrc(nirogiLogo)} alt="Nirogi Tanman logo" className="h-12 w-12 object-contain" />
              <span className="text-sm font-normal tracking-wide">Nirogi Tanman</span>
            </div>
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-8 gap-y-3">
              <li>
                <Link href="/" className="text-background/70 hover:text-background smooth-hover text-xs font-light">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/locations" className="text-background/70 hover:text-background smooth-hover text-xs font-light">
                  Locations
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-background/70 hover:text-background smooth-hover text-xs font-light">
                  About
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-background/70 hover:text-background smooth-hover text-xs font-light">
                  Contact
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/admin" className="text-background/70 hover:text-background smooth-hover text-xs font-light">
                  Admin Panel
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-background/20 pt-8 mt-12 text-center text-background/50 text-xs font-light">
          <p>&copy; 2026 Nirogi Tanman. All rights reserved.</p>
        </div>
      </div>
    </footer>;
};
